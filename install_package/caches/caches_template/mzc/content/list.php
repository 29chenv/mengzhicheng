...
<!--main-->
<section style="min-height: 735px;margin-left:390px">
	<div class="col-left">
    	<div class="crumbs  wow fadeInDown animated">
            <h2><a href="<?php echo siteurl($siteid);?>">首页</a><span> > </span><?php echo catpos($catid);?> 列表</h2>
        </div>
            ...
            <ul class="list lh24 f14 wow fadeInDown animated">
            <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
                <h6><li><span class="rt"><?php echo date('Y-m-d H:i:s',$r[inputtime]);?></span>·<a href="<?php echo $r['url'];?>" target="_blank"<?php echo title_style($r[style]);?>><?php echo $r['title'];?></a></li></h6>
    ...
    <div class="col-auto">
        <div class="box">
            <h2 class="title-2 wow fadeInDown animated">频道总排行</h2>
            ...
            <ul class="content digg wow fadeInDown animated">
				<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
                <h6><li><a href="<?php echo $r['url'];?>" target="_blank"><?php echo $r['title'];?></a></li></h6>
				<?php $n++;}unset($n); ?>
            </ul>
            <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
        </div>
        <div class="bk10"></div>
        <div class="box">
            <h2 class="title-2 wow fadeInDown animated">频道本月排行</h2>
            ...
            <ul class="content rank wow fadeInDown animated">
				<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
                <h6><li><span><?php echo number_format($r[monthviews]);?></span><a href="<?php echo $r['url'];?>"<?php echo title_style($r[style]);?> class="title" title="<?php echo $r['title'];?>"><?php echo str_cut($r[title],56,'...');?></a></li></h6>
				<?php $n++;}unset($n); ?>
            </ul>
            <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
        </div>
